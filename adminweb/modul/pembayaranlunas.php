...
<th>NAMA PEMESAN</th>
		  	...
		  	$b = mysql_query($tampil="SELECT orderdata.*,member.* FROM orderdata, member where member.id_member=orderdata.id_member AND member.StatusOrder = 'Lunas' ORDER BY username ASC")or die($tampil.'<br>error</br>'.mysql_error());;
